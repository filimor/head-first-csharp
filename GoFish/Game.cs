...
namespace GoFish
{
    public class Game
    {
        ...
        private void Deal()
        {
            // Será aqui o método A PARTIR DO QUAL o jogo começa - ele será chamado apenas no início
            // do jogo. Ele embaralha o monte, dá cinco cartas para cada jogador e usa um laço
            // foreach para chamar o método PullOutBooks() de cada um.
        ...
        {
            // Monte um livro para um jogador. Retorne true se o jogador ficar sem cartas. Se não
            // for o caso, retorne false. Cada livro deve ser adicionado ao dicionário _books. Um
            // jogador fica sem cartas quando usar todas as suas restantes para montar um livro - e
            // assim tentar ganhar o jogo.
        ...
        {
            // Retorna uma longa string que descreve os livros de todos, composta examinando o
            // dicionário _books. "João tem um livro de seis. (quebra de linha) Edu tem um livro de Ases".
        ...
        public string GetWinnerName()
        {
            ...
            // dicionário para encontrar o maior número de livros, o que determina o vencedor. E
            // finalmente ele faz uma última passagem por winners para montar uma string com o nome
            // dos vencedores ("João e Edu", por exemplo). Se temos um único vencedor, ele deve
            // retornar uma string como "Edu com três livros". Se temos mais de um, ele deve
            // retornar algo como "um empate entre João e Beto com 2 livros".

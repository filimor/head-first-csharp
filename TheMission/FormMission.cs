...
namespace TheMission
{
    public partial class FormMission : Form
    {
        ...
        {
            // Lê a localização do jogador, dos inimiogs e de qualquer arma presente na masmorra no
            // momento e certifica-se de que as caixas de imagem estejam nos lugares certos. Também
            // checa o inventário do jogador e certifica-se de que os ícones corretos sejam exibidos
            // no pergaminho de inventário.

            // Quando todos os objetos tenham se movido e atuados uns sobre os outros, o formulário
            // atualiza tudo. Então as armas que foram pegas têm sua propriedade Visible de suas
            // caixas de imagem igualadas a false, inimigos e jogadores são colocados em seus novos
            // lugares (e os mortos ficam invisíveis) e o inventário é atualizado.
            ...
            // Depois que você iterou por todos os inimigos no nível, cheque a variável showBat. Se
            // o morcego foi morto, então será false, logo deixe sua PictureBox invisível e apague
            // seu rótulo de pontos de vida. Depois faça o mesmo para showGhost e showGhoul.
            ...
            // Use o método CheckPlayerInventory() do objeto Game para descobrir se os diversos
            // ícones no inventário devem ser exibidos.
            ...
            // Todo nível tem uma arma. Se ela foi recolhida, precisamos deixar seu ícone invisível.
        ...
        // Quando o jogador clicar numa arma, primeiro verifica-se se ela está no inventário usando
        // o método CheckPlayerInventory() do objeto Game. Se o jogador estiver de posse da arma,
        // chama _game.Equip() para que o jogador a segure. Então configura cada propriedade
        // BorderStyle de PicutreBox para desenhar uma caixa em volta da arma e certifica-se de que
        // nenhum dos outros itens têm uma caixa em volta deles.
        ...
        // Primeiro o botão chama _game.Move() com o valor de Direction apropriado, e então chama o
        // método UpdateCharacters().
        ...
        // Cada botão chama _game.Attack() e então o método UpdateCharacters(). Se o jogador prepara
        // uma poção, ela ainda é usda da mesma forma - chamando _game.Attack() - mas ela não tem
        // direção. Então deixe os botões Esquerda, Direita e Para Baixo invisíveis quando o jogador
